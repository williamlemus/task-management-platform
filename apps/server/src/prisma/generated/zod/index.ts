...
export const TaskScalarFieldEnumSchema = z.enum(['id','createdAt','updatedAt','title','description','status','deletedAt','userId']);
...
export const StatusSchema = z.enum(['Pending','InProgress','Completed']);
